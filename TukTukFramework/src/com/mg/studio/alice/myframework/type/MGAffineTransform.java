 ...
 * @since Android 1.0
 */
public class MGAffineTransform {
    ...
    public static MGAffineTransform identity() {
        return new MGAffineTransform();
    }
     ...
     */
    public MGAffineTransform(MGAffineTransform t) {
        this.type = t.type;
        this.m00 = t.m00;
        this.m10 = t.m10;
        this.m01 = t.m01;
     ...
     */
    public MGAffineTransform(float m00, float m10, float m01, float m11, float m02, float m12) {
     ...
     * @param m12 the m12 entry in the transformation matrix.
     */
    public MGAffineTransform(double m00, double m10, double m01, double m11, double m02, double m12) {
        this.type = TYPE_UNKNOWN;
        this.m00 = m00;
        this.m10 = m10;
        this.m01 = m01;
    ...
    public static MGAffineTransform make(double m00, double m10, double m01, double m11, double m02, double m12) {
        return new MGAffineTransform(m00, m10, m01, m11, m02, m12);
    }
     ...
     */
    public MGAffineTransform(float[] matrix) {
        this.type = TYPE_UNKNOWN;
        m00 = matrix[0];
        m10 = matrix[1];
        m01 = matrix[2];
     ...
     * @throws ArrayIndexOutOfBoundsException if the size of the array is 0, 1, 2, 3, or 5.
     */
    public MGAffineTransform(double[] matrix) {
        this.type = TYPE_UNKNOWN;
        m00 = matrix[0];
        m10 = matrix[1];
        m01 = matrix[2];
     ...
     */
    public void setTransform(MGAffineTransform t) {
     ...
     */
    public static MGAffineTransform makeTranslation(double mx, double my) {
        MGAffineTransform t = new MGAffineTransform();
     ...
     * @return the new AffineTransformation.
     */
    public static MGAffineTransform makeScale(double scx, double scY) {
        MGAffineTransform t = new MGAffineTransform();
     ...
     * @return the new AffineTransformation.
     */
    public static MGAffineTransform makeShear(double shx, double shy) {
        MGAffineTransform m = new MGAffineTransform();
     ...
     * @return the new AffineTransformation.
     */
    public static MGAffineTransform makeRotation(double angle) {
        MGAffineTransform t = new MGAffineTransform();
     ...
     * @return the new AffineTransformation.
     */
    public static MGAffineTransform makeRotation(double angle, double x, double y) {
        MGAffineTransform t = new MGAffineTransform();
     ...
     * @param my the distance to translate in the y direction.
     */
    public MGAffineTransform getTransformTranslate(double mx, double my) {
        return getTransformConcat(MGAffineTransform.makeTranslation(mx, my));
    }
     ...
     * @param scy the scaling factor in the y direction.
     */
    public MGAffineTransform getTransformScale(double scx, double scy) {
        return getTransformConcat(MGAffineTransform.makeScale(scx, scy));
    }
    ...
    public void shear(double shx, double shy) {
        getTransformConcat(MGAffineTransform.makeShear(shx, shy));
    }
     ...
     * @param angle the angle of rotation in radians.
     */
    public MGAffineTransform getTransformRotate(double angle) {
        return getTransformConcat(MGAffineTransform.makeRotation(angle));
    }
    ...
    public void rotate(double angle, double px, double py) {
        getTransformConcat(MGAffineTransform.makeRotation(angle, px, py));
    }
     ...
     *         the matrix t2.
     */
    public static MGAffineTransform multiply(MGAffineTransform t1, MGAffineTransform t2) {
        return new MGAffineTransform(t1.m00 * t2.m00 + t1.m10 * t2.m01, // m00
     ...
     */
    public MGAffineTransform getTransformConcat(MGAffineTransform t) {
     ...
     *          by.
     */
    public MGAffineTransform preConcatenate(MGAffineTransform t) {
     ...
     */
    public MGAffineTransform getTransformInvert() /*throws NoninvertibleTransformException*/ {
        double det = getDeterminant();
        if (Math.abs(det) < ZERO) {
//            throw new NoninvertibleTransformException("Determinant is zero");
            return this;
        }
        return new MGAffineTransform(m11 / det, // m00
                -m10 / det, // m10
                -m01 / det, // m01
                m00 / det, // m11
     ...
     *         point is sent.
     */
    public MGPointF applyTransform(MGPointF src) {
        MGPointF dst = MGPointF.make(0, 0);
     ...
     */
    public void transform(MGPointF[] src, int srcOff, MGPointF[] dst, int dstOff, int length) {
        while (--length >= 0) {
            MGPointF srcPoint = src[srcOff++];
            double x = srcPoint.x;
            double y = srcPoint.y;
            MGPointF dstPoint = dst[dstOff];
            if (dstPoint == null) {
                dstPoint = MGPointF.zero();
            }
    ...
    public MGPointF deltaTransform(MGPointF src, MGPointF dst) {
        if (dst == null) {
            dst = MGPointF.make(0, 0);
        }
     ...
     *          of the linear transformation part is zero).
     */
    public MGPointF inverseTransform(MGPointF src, MGPointF dst)
            throws NoninvertibleTransformException {
        double det = getDeterminant();
        if (Math.abs(det) < ZERO) {
    ...
    public void multiply(MGAffineTransform t) {
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MGAffineTransform) {
            MGAffineTransform t = (MGAffineTransform) obj;
    ...
    public static void CGAffineToGL(MGAffineTransform t, float []m) {
    ...
    public static void GLToCGAffine(float []m, MGAffineTransform t) {
