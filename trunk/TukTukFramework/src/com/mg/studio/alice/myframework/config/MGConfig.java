package com.mg.studio.alice.myframework.config;
...
public class MGConfig {
     ...
     */
    public static final int FRAMEWORK_DEBUG = 2;
    ...
    /** @def DIRECTOR_DISPATCH_FAST_EVENTS
    ...
    /** @def SPRITESHEET_RENDER_SUBPIXEL
    ...
    /** @def NODE_TRANSFORM_USING_AFFINE_MATRIX
    ...
    */
    public static final boolean NODE_TRANSFORM_USING_AFFINE_MATRIX  = true;
